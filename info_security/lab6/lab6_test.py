...
from lab6.lab_6 import encrypt_start
...
if __name__ == '__main__':
    print("\nАнгл текст:\n")
    print(f"Залежність часу шифрування алежно від об’єму повідомлення: {eng_enc_test()}")
    ...
    print(f"\nУкр текст:\n")
    print(f"Залежність часу шифрування алежно від об’єму повідомлення: {ukr_enc_test()}")
